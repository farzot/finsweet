<template>
  <div
    class="flex justify-center items-center text-[#282938] my-24 mt-0 py-24"
  >
    <div class="container block items-center md:w-3/5 md:px-32">
      <p class="text-center">What we created</p>
      <div class="middle space-y-6 mt-1">
        <p class="font-semibold text-5xl text-center">Our Work Portfolio</p>
        <p class="text-center">
      ...
      <div class="stikerlar flex space-x-7 justify-center mt-8">
        <svg
